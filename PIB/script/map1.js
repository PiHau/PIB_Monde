Promise.all([
    ...
    const projection = d3.geoOrthographic()
        .scale(240)  // Réduit la taille de la sphère de 20%
    ...
    // Ajouter un cercle bleu derrière la sphère
    svg.append('circle')
    ...
    function updateGraph(data) {
        ...
        g.append('g')
            .call(d3.axisLeft(y).ticks(5).tickFormat(d3.format(".2s"))) // Adapte la légende pour éviter les nombres à virgule
            .append('text')
            .attr('fill', '#000')
    ...
    function updateComparison(countryPibHab, suissePibHab, countryName) {
        ...
        const numStickmen = Math.ceil(suissePibHab / countryPibHab);
    ...
    // Ajouter le texte "PIB/habitant [$]" sous la légende
    svg.append("text")
